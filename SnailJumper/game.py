...
import pygame
from plot_generation import Plot_generation


def write_to_file():
    print('omaaaaad')
    with open('data_avg.json', 'w') as f:
        json.dump(evolution.avg_fitness, f)
    with open('data_max.json', 'w') as f:
        json.dump(evolution.max_fitness, f)
    with open('data_min.json', 'w') as f:
        json.dump(evolution.min_fitness, f)
